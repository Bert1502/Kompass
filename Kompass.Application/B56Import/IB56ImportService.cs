...
public sealed class B56ImportService : IB56ImportService
{
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        try
        {
            ...
            var pruefung = _dateiPruefer.Pruefen(anfrage.Quelldateipfad);
            ...
            var sha256 = await _hashService.BerechnenAsync(
            ...
            {
                var archivHash = await _hashService.BerechnenAsync(
                    archivdateipfad,
                    cancellationToken);
                ...
                {
                    VersucheDateiZuLoeschen(archivdateipfad);
            ...
            var ergebnis = B56ImportErgebnis.Erfolgreich(
                eintrag,
                pruefung.VollstaendigerDateipfad);
    ...
    private static void VersucheDateiZuLoeschen(string dateipfad)
    {
